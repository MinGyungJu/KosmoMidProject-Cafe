...
<<<<<<< HEAD
		...
		// 메뉴 관련버튼 (이미지 경로)
		bnd1 = new JButton("너구리:3500원", new ImageIcon("src\\imgs_noodle\\1.PNG"));
		bnd2 = new JButton("신라면:3500원", new ImageIcon("src\\imgs_noodle\\2.PNG"));
		bnd3 = new JButton("오징어짬뽕:3500원", new ImageIcon("src\\imgs_noodle\\3.PNG"));
		bnd4 = new JButton("튀김우동:3500원", new ImageIcon("src\\imgs_noodle\\4.PNG"));
		bnd5 = new JButton("진라면:3000", new ImageIcon("src\\imgs_noodle\\5.PNG"));
		bnd6 = new JButton("짜파게티:3500원", new ImageIcon("src\\imgs_noodle\\6.PNG"));
		// 주문 관련 버튼
